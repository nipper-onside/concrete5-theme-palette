...
<?php } else { ?>
					...
					<section class="announcement">
						<?php if ($pageListTitle): ?>
							<h2 class="section-title"><?php echo h($pageListTitle) ?></h2>
						<?php endif; ?>
						<?php if ($rssUrl): ?>
							...
							<li>
								...
								<div class="ccm-block-page-list-title">
									<?php if (isset($useButtonForLink) && $useButtonForLink) { ?>
										<time datetime="<?php echo $datetime; ?>"><?php echo $date; ?></time> <span><?php echo $title ?></span><?php echo $new ?>
									<?php } else { ?>
										<a href="<?php echo $url ?>" target="<?php echo $target ?>"><time datetime="<?php echo $datetime; ?>"><?php echo $date; ?></time> <?php echo $title ?></a><?php echo $new ?>
									<?php } ?>
					                </div>
								<?php endif; ?>
