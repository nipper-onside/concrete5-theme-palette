...
<?php echo '<nav class="palette-footer-navigation"><ul class="nav">'; //opens the top-level menu

foreach ($navItems as $ni) {

if ($ni->cObj->getAttribute('pa_include_footer_nav')) {
...
?>
<?php //endif; ?>
<?php //echo '<div class="ccm-responsive-menu-launch"><i aria-hidden="true"></i></div>'; // empty i tag for attaching :after or :before psuedos for things like FontAwesome icons.