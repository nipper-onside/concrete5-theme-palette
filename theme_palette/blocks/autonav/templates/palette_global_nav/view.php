...
?>
			<nav id="dl-menu" class="palette-global-navigation">
...
<?php echo '<ul class="palette-nav dl-menu">'; //opens the top-level menu
foreach ($navItems as $ni) {
    ...
    if ($ni->hasSubmenu) {
        echo '<ul class="dl-submenu">'; //opens a dropdown sub-menu
    } else {
