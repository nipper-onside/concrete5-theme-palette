...
if (count($navItems) > 0) {
	...
	echo '<div class="palette-bread-crumbs">'; //opens the top-level menu
    echo '<div class="container">';
    echo '<div class="row">';
    echo '<nav role="navigation" aria-label="breadcrumb" class="col-sm-12">'; //opens the top-level menu
    ...
    foreach ($navItems as $num => $ni) {
      ...
      itemtype="http://schema.org/ListItem" class="active"><span itemprop="name">' . $ni->name . '</span><meta itemprop="position" content="' .$num. '" /></li>';
        } else {
            echo '<li itemprop="itemListElement" itemscope
